                        ...
                        <div class="table-responsive"> 
                          <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                              ...
                              $reponse = $db->query("SELECT * FROM perso WHERE MEMBRE=1 ORDER BY PRENOMNOM ASC");
                              while($donnees = $reponse->fetch()){
                                ?>
                              <tr>
                               <td width=1%><?= $donnees['MEMBRE']?></td> 
                                <td><?= $donnees['PRENOMNOM'] ?></td>
                                <td ><?= $donnees['PROFESSION']?></td>
                                <td><?= $donnees['SEXE']?></td>  
                                <td><?= $donnees['DATENAISSANCE']?></td>            
                                <td><?= $donnees['ADRESSE']?></td>      
                                  
                                <td align="center">
                                  <a href="details.php?det=<?= $donnees['IDPERSONNEL']?>"><i class="mdi mdi-clipboard-outline"></i></a>
                                  <a href="modifcl.php?mo=<?= $donnees['IDPERSONNEL']?>"><i class="mdi mdi-pencil"></i></a>
                                </td>
                              </tr>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control" placeholder="Code client" name="NumClient">
              </div>
              </div>
              <div class="col-md-6">
              <div class="form-group">
              ...
              <button type="submit" class="btn btn-primary" name="bt_PERSO">Ajouter</button>
          </div>
        </div>
      </div>
    </div>
